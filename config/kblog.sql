...
CREATE TABLE `article` (
  ...
  `categoryId` int(10) DEFAULT '999' COMMENT '标签',
  `author` varchar(255) DEFAULT 'KingJA' COMMENT '作者',
  `display` tinyint(4) DEFAULT '0' COMMENT '1 发布 0 草稿',
  `top` tinyint(4) DEFAULT '0' COMMENT '1 置顶 0 默认',
  PRIMARY KEY (`id`),
...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES ('1', '1', '怎么写一篇高逼格的技术文章1', '正如标题所言，到底怎么写呢', '2017-01-07 11:15:54', '2017-01-12 13:35:44', '456', '0', null, 'KingJA', '1', '0');
...
INSERT INTO `category` VALUES ('13', '模式', '2017-01-11 10:26:24');
INSERT INTO `category` VALUES ('15', 'Html5', '2017-01-11 17:11:28');
INSERT INTO `category` VALUES ('16', '读书笔记', '2017-01-12 10:43:10');
INSERT INTO `category` VALUES ('999', '其他', '2017-01-12 10:43:39');
...
CREATE TABLE `comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '' COMMENT '评论人姓名',
  `site` varchar(255) DEFAULT '' COMMENT '网站',
